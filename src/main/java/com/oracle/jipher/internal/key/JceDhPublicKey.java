...
/**
 * {@link DHPublicKey} implementation with an {@code EVP_PKEY} backed key.
 */
public final class JceDhPublicKey extends JceOsslPublicKey implements DHPublicKey {
    ...
    public JceDhPublicKey(Pkey pkey, byte[] encoding) throws InvalidKeyException {
        super(ALG, pkey, encoding);
        this.pub =  this.pkey.getDhPublicKey();
    ...
    /**
     * Encodes the DH public key as
     * <pre>
     * PublicKeyInfo ::= SEQUENCE {
     *     publicKeyAlgorithm  AlgorithmIdentifier
     *     publicKey           BIT STRING}
     * </pre>
     * as defined in <a href="https://www.rfc-editor.org/rfc/rfc5280.html">RFC 5208</a>,
     * where AlgorithmIdentifier is defined in CCITT. Recommendation X.509
     *
     * <p>
     * The publicKeyAlgorithm algorithm ID can be either:
     * <pre>
    ...
    byte[] derEncode() {
        ...
        return dhPubKey.encodeDerOctets();
    }

    @Override
    public String toString() {
        return "DHPublicKey: params=[P=" + this.params.getP() + ",G=" + this.params.getG() +
                "],pubValue=" + this.pub;
    }
}
