...
public class UnsanctionedCryptoLibraryVersionTest {
    ...
    @BeforeAll
    static void checkSanctionedCryptoLibraryVersionsSystemPropertySettings() {
        // This system test assumes Jipher has been configured with an empty crypto library version range.
        ...
        for (String prefix : new String[]{"jipher.openssl.sanctioned.", "jipher.openssl.sanctioned.osProvided."}) {
            String propertyName = prefix + "cryptoLibraryVersions";
    ...
    private void validateCause(Throwable t) {
        ...
        Assertions.assertTrue(message.contains("OpenSSL cryptography library version"));
